...
function Products({cartItems, favoriteItems, setCartItems, setfavoriteItems, cartCtr, setCartCtr}) {
    const allProducts = [
        ...
        },
        {
            id:2,
            brand:"ASUS",
            title:"2021 ASUS TUF Gaming F15 FX506r",
    ...
    return (
        <div className="container-fluid product-div bg-primary">
            ...
            <div className="container d-flex row justify-content-around m-auto mt-3  ">
                {allProducts.map((product, idx) => (
                    <div className="prod-crd card my-3" style={{ width: "18rem" }} key={idx}>
                        <div className="heart-icon  bg-primary" onClick={() => addToFavorites(product.id)}>
                        ...
                        <div className="card-body prod-body content-fluid ">
                            ...
                            <div className="d-flex justify-content-between  ">
                                ...
                                <button className="buy-now btn bg-primary" onClick={() => buyNow()}>Buy</button>
